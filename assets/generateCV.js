...
${data['languages'][l_ind]['name']}
          ...
          sect_list.push('<div class="detail_right">');
          sect_list.push(`<div class="degree">
      ...
      case 'programming_languages':
        ...
        for (pl_ind in pl_data) {
          ...
          if ('icon_url' in pl_data[pl_ind]) {
            let p_ico = ['<div class="name">', '<img class="lazyloaded" src="', pl_data[pl_ind]["icon_url"], '" alt="', pl_data[pl_ind]["name"], '"/>  ', pl_data[pl_ind]["name"], '</div>'];
            for (pk in p_ico)
...
${pl_data[pl_ind]['os']}</div>`);
      ...
      case 'projects':
        ...
        sect_proj[2] = 'projects / public repos'
        var sect_list = Array();
        var side_switch = true;
